$(document).ready(function () {
    ...
    $(".slices > a").click(function(event) {
        var first=($(event.target).closest("a").attr('class').split(' ')[0]);
        var Bodyfirst=($(event.target).closest("body").attr('class'));
    ...
    $("#slice1").click(function () {
        ...
        $("#circle1").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice2").click(function () {
        ...
        $("#circle2").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice3").click(function () {
        ...
        $("#circle3").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice4").click(function () {
        ...
        $("#circle4").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice5").click(function () {
        ...
        $("#circle5").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice6").click(function () {
        ...
        $("#circle6").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice7").click(function () {
        ...
        $("#circle7").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice8").click(function () {
        ...
        $("#circle8").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice9").click(function () {
        ...
        $("#circle9").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice10").click(function () {
        ...
        $("#circle10").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice11").click(function () {
        ...
        $("#circle11").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice12").click(function () {
        ...
        $("#circle12").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice13").click(function () {
        ...
        $("#circle13").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice14").click(function () {
        ...
        $("#circle14").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice15").click(function () {
        ...
        $("#circle15").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice16").click(function () {
        ...
        $("#circle16").siblings().addClass("inrCircHide");
    });
    ...
    $("#slice17").click(function () {
        ...
        $("#circle17").siblings().addClass("inrCircHide");
    });
